...
Stolen bikes are a typical problem in Sydney. The Police want to be more efficient in resolving stolen bike cases. They decided to build a software that can automate their processes — the software that you're going to develop.
...
- [ ] I want to see a list of reported bike thefts for the Sydney area.
...
- [BikeIndex](https://bikeindex.org/bikes?serial=&button=&location=Sydney&distance=300&stolenness=proximity)
